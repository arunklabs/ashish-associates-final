...
type TooltipContentProps = {
  active?: boolean;
  payload?: Array<Record<string, unknown> & { value?: unknown; name?: string; dataKey?: string; payload?: Record<string, unknown>; fill?: string; color?: string }>;
  label?: string;
  hideLabel?: boolean;
                    ...
                    >
                      ...
                      {item.value != null ? (
                        <span className="font-mono font-medium tabular-nums text-foreground">
                          {typeof (item.value as Record<string, unknown>)?.toLocaleString === "function"
                            ? (item.value as { toLocaleString: () => string }).toLocaleString()
                            : String(item.value)}
                        </span>
                      ) : null}
                    </div>
